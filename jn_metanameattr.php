...
class Jn_metanameattr extends Module
{
    ...
    {
        Configuration::deleteByName('JN_METANAMEATTR_LIVE_MODE');
    ...
    public function getContent()
    {
         ...
         */
        if (((bool)Tools::isSubmit('submitJn_metanameattrModule')) == true) {
            $this->postProcess();
        }
    ...
    protected function renderForm()
    {
        ...
        $helper->submit_action = 'submitJn_metanameattrModule';
            ...
            'form' => array(
                ...
                'input' => array(
                    array(
                        ...
                        'name' => 'JN_METANAMEATTR_LIVE_MODE',
                        'is_bool' => true,
                    ...
                    array(
                        ...
                        'name' => 'JN_METANAMEATTR_ACCOUNT_EMAIL',
                        'label' => $this->l('Email'),
                    ),
                    array(
                        'type' => 'password',
                        'name' => 'JN_METANAMEATTR_ACCOUNT_PASSWORD',
    ...
    {
        return array(
            'JN_METANAMEATTR_LIVE_MODE' => Configuration::get('JN_METANAMEATTR_LIVE_MODE', true),
            'JN_METANAMEATTR_ACCOUNT_EMAIL' => Configuration::get('JN_METANAMEATTR_ACCOUNT_EMAIL', 'contact@prestashop.com'),
            'JN_METANAMEATTR_ACCOUNT_PASSWORD' => Configuration::get('JN_METANAMEATTR_ACCOUNT_PASSWORD', null),
        );
    }
